...
authors: Klaus S. Larsen, Anders Michelsen, Sven Jonasson, Claus Beier, Paul Grogan
citekey: larsen2012
year: "2012"
tags:
  - nitrogen
...
imported: 2026-05-28
---
- **Document**:: [PDF](zotero://select/library/items/GKQIRD9T)
- **Link**:: https://doi.org/10.1007/s10021-012-9555-x
...
# Notes 
- [a] investigate timing of nitrogen uptake by different functional groups in a wet heathland using a 15N tracer.
    1. N uptake varies based on growth form specific seasonal variation in photosynthesis and N demands.
    2. evergreen growth forms have exhibit higher N uptake during winter and early spring.
    
- [N] the tracer was added once and seasonal uptake war measured during fall, winter, spring, and early summer.

- tracer recovery across all growth forms was at most a fraction of a percentage of added amount across seasons.

![[can N tracers act as fertilizers]]
- microbial biomass C peaked in late winter and decline during snowmelt (may be controlled by changes in temperature and C availability)
    - declines in microbial biomass C were not associated with increased inorganic N

![[temporal niche differentiation of N uptake among tundra functional groups]]

# Critical Reading
**Key assumptions made**
Only one 15N tracer was added in the form of glycine (amino acid), *the assumption here being that all functional groups are equally capable of accessing it*.
Seasons are not clearly defined or differentiated, it's more a temporal distinction unrelated to phenology.
*NEVER MIND*, the tracer was likely equally inaccessible to all studied functional groups

# Connections
**Cited papers of interest**
- [r] niche differentiation among functional groups based on preferred N form [[@mckane2002]]
